...
# Stable filtering for shared ADS/I2C noise:
# - read enough samples per channel to absorb short voltage dips
# - use the upper half of each sample set to avoid low-dropout noise
# - smooth with a rolling median and EMA so UI values do not jump
SAMPLE_COUNT = 15
SAMPLE_DELAY_SEC = 0.005
